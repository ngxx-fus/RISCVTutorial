...
{
	long i;
	REG32(spi, SPI_REG_SCKDIV) = (F_CLK / 300000);
...
static int copy(void)
{
	...
	//REG32(spi, SPI_REG_SCKDIV) = (F_CLK / 16666666);
	REG32(spi, SPI_REG_SCKDIV) = (F_CLK / 5000000);
...
int main(void)
{
	...
	kputs("Hello world FROM NGXXFUS :VVVVV (custom for ZYNQ7000)\r\n");
