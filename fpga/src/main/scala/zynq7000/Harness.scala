...
class Zynq7000woDDRHarness(override implicit val p: Parameters) extends Zynq7000ShellCustomOverlays
{
  ...
  println(s"Zynq7000 FPGA Base Clock Freq: ${dutFreqMHz} MHz")
  ...
  override lazy val module = new Zynq7000woDDRHarnessImp(this)
}

class Zynq7000woDDRHarnessImp(_outer: Zynq7000woDDRHarness) extends LazyRawModuleImp(_outer)
